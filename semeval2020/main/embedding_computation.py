...
for tokenized_sentence, target_word_idx_dict in tokenized_target_sentences:
    ...
    target_embeddings = bert_model.compute_embeddings(input_id_tensor, attention_mask, target_word_idx_dict)
