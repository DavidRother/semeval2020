...
for fig_idx, word in enumerate(target_words):
    ...
    plt.title(f"{preprocessing_method} embedded {model_name} clustered {word} Estimated Senses")
    ...
    plt.title(f"{preprocessing_method} embedded {model_name} clustered {word} True Senses")
